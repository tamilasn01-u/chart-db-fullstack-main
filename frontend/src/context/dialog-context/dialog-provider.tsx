...
import type { ExportDataDictionaryDialogProps } from '@/dialogs/export-data-dictionary-dialog/export-data-dictionary-dialog';
import { ExportDataDictionaryDialog } from '@/dialogs/export-data-dictionary-dialog/export-data-dictionary-dialog';
...
export const DialogProvider: React.FC<React.PropsWithChildren> = ({
    ...
    const openExportDataDictionaryDialogHandler: DialogContext['openExportDataDictionaryDialog'] =
        useCallback(
            (params) => {
                setExportDataDictionaryDialogParams(params);
                setOpenExportDataDictionaryDialog(true);
            },
            [setOpenExportDataDictionaryDialog]
        );
