...
export interface DialogContext {
    ...
    openExportDataDictionaryDialog: (
        params?: Omit<ExportDataDictionaryDialogProps, 'dialog'>
    ) => void;
    closeExportDataDictionaryDialog: () => void;
...
export const dialogContext = createContext<DialogContext>({
    ...
    openExportDataDictionaryDialog: emptyFn,
    closeExportDataDictionaryDialog: emptyFn,
