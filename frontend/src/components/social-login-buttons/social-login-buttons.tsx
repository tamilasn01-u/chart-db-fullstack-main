...
export const SocialLoginButtons: React.FC<SocialLoginButtonsProps> = ({
    ...
    const [providers, setProviders] = useState<OAuth2Providers | null>(null);
    ...
    // Don't render anything if loading or no providers configured
    if (loading) {
        return null;
    }
        ...
        <div className={`space-y-3 ${className}`}>
            ...
            {providers?.zoho && (
                <Button
                    ...
                    className="w-full"
                    disabled={disabled}
                    onClick={() => handleOAuth2Login('zoho')}
                >
                    <svg className="mr-2 size-5" viewBox="0 0 24 24">
                        <path
                            fill="#C8202B"
